...
<html lang="en">
  ...
  <head>
    ...
    <link href='<?php echo base_url(); ?>https://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,800italic,400,300,600,700,800' rel='stylesheet' type='text/css'>
    <link href='<?php echo base_url(); ?>https://fonts.googleapis.com/css?family=Merriweather:400,300,300italic,400italic,700,700italic,900,900italic' rel='stylesheet' type='text/css'>
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="<?php echo base_url();?>#page-top">Start Bootstrap</a>
    ...
    <section class="bg-dark text-white">
      <div class="container text-center">
        ...
        <a class="btn btn-light btn-xl sr-button" href="<?php echo base_url();?>http://startbootstrap.com/template-overviews/creative/">Download Now!</a>
      </div>
    </section>
